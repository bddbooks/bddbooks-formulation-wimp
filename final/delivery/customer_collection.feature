...
Rule: Unauthenticated customers must supply acceptable contact details when placing an order for customer-collection
...
Rule: Customer should be informed when their order will be ready for customer-collection
